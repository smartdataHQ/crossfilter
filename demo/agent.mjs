...
var AGENT_SYSTEM_PROMPT = [
  ...
  '- Dimensions with 30+ unique values (municipality, locality, poi_name, vehicle_model, etc.) → lazy section',
  '- Dimensions with <20 unique values (region, fuel_type, stay_type, activity_type) → safe for main query',
